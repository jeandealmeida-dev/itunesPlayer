...
val AppTypography = Typography(
    ...
    titleLarge = TextStyle(fontFamily = ArticulatCF, fontWeight = FontWeight.Medium, fontSize = 22.sp),
    ...
    bodyLarge = TextStyle(fontFamily = ArticulatCF, fontWeight = FontWeight.Medium, fontSize = 16.sp),
